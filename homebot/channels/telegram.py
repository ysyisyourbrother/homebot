...
from homebot.command.builtin import build_help_text
from homebot.config.paths import get_media_dir
from homebot.config.schema import Base
from homebot.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical homebot commands."""
    ...
    async def start(self) -> None:
        ...
        self._app.add_handler(
            MessageHandler(
                filters.Regex(r"^/(new|stop|restart|status)(?:@\w+)?(?:\s+.*)?$"),
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm homebot.\n\n"
