...
class BaseChannel(ABC):
    ...
    to integrate with the homebot message bus.
    """
    ...
    def __init__(self, config: Any, bus: MessageBus):
        ...
        self.bus = bus
        self._running = False
        self._session_cleanup: Callable[[str], Any] | None = None
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from homebot.providers.transcription import OpenAITranscriptionProvider
                ...
                from homebot.providers.transcription import GroqTranscriptionProvider
