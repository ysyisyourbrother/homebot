...
RESTART_NOTIFY_CHANNEL_ENV = "HOMEBOT_RESTART_NOTIFY_CHANNEL"
RESTART_NOTIFY_CHAT_ID_ENV = "HOMEBOT_RESTART_NOTIFY_CHAT_ID"
RESTART_STARTED_AT_ENV = "HOMEBOT_RESTART_STARTED_AT"
